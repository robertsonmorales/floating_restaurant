...
<div class="filters">
    <div class="filters-child">
        <button onclick="window.location.href='{{ route('expense_categories.create') }}'" class="btn btn-primary" id="btn-add-record">{{ $add }}</button>
...
$(document).ready(function(){
    ...
    columnDefs = {
        ...
        cellRenderer: function(params){
            ...
            var edit_url = '{{ route("expense_categories.edit", ":id") }}';
    ...
    $('#btn-remove').on('click', function(){
        var destroy = '{{ route("expense_categories.destroy", ":id") }}';
