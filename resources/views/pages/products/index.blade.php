...
<div class="filters mx-4 mb-3">
    <div class="filters-child">
        <button onclick="window.location.href='{{ route('products.create') }}'" class="btn btn-primary" id="btn-add-record">{{ $add }}</button>
...
$(document).ready(function(){
    ...
    columnDefs = {
        ...
        cellRenderer: function(params){
            ...
            var edit_url = '{{ route("products.edit", ":id") }}';
    ...
    $('#btn-import-submit').on('click', function(){
        ...
        document.getElementById("import-form-submit").action = "{{ route('products.import') }}";
    ...
    $('#btn-remove').on('click', function(){
        var destroy = '{{ route("products.destroy", ":id") }}';
