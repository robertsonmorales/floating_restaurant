...
<div class="d-flex flex-column align-items-center">
    <form action="{{ ($mode == 'update') ? 
        route('order_substatus.update', $data->id) : 
        route('order_substatus.store') }}"
        ...
        <div class="actions">           
            ...
            <button type="button" onclick="window.location.href='{{route('order_substatus.index') }}'" class="btn btn-secondary" id="btn-back">Back</button>
        </div>
